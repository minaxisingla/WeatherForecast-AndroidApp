package com.example.minaxi.weatherforecast571;
        ...
        OnAerisMapLongClickListener, AerisCallback
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        AerisEngine.initWithKeys(this.getString(R.string.aeris_client_id), this.getString(R.string.aeris_client_secret), "com.example.minaxi.weatherforecast571");
